        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-2 mb-4">
             ...
             <img src="https://vaidyji.com/wp-content/uploads/2025/01/iguoxrli_wamidHBgMOTE3MDExNzYxMzQwFQIAEhgUM0FFNTAzQURGNDA5NTk5ODNGM0MA-e1737099330572.png" alt="My Logo" className="w-20 h-20rounded-100%" />
