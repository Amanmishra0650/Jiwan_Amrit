...
//             <div className='N'>
//               <img src='https://vaidyji.com/wp-content/uploads/2025/01/iguoxrli_wamidHBgMOTE3MDExNzYxMzQwFQIAEhgUM0FFNTAzQURGNDA5NTk5ODNGM0MA-e1737099330572.png' alt='Logo'/>
//             </div>
//           </Link>
      ...
      <div className="container mx-auto px-4"> 
        <div className="flex items-center justify-between">
          ...
          <Link to="/" className="flex items-center space-x-2">
            <div className="N">
              <img
                src="https://vaidyji.com/wp-content/uploads/2025/01/iguoxrli_wamidHBgMOTE3MDExNzYxMzQwFQIAEhgUM0FFNTAzQURGNDA5NTk5ODNGM0MA-e1737099330572.png"
                alt="Logo"
              />
            </div>
          </Link>
