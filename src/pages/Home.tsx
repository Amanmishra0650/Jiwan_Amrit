...
//   return (
//     <div className="stats-container flex gap-10 justify-center my-10">
//       {stats.map(({ icon: Icon, label, value }, index) => (
//         <div key={index} className="stat-item flex flex-col items-center">
//           {/* Icon with increased size */}
//           <Icon size={48} className="text-emerald-600 mb-2" />
...
//                 Ancient Wisdom,
//                 <span className="text-blue-400"> Modern Care</span>
//               </h1>
...
//                 <Link
//                   to="/appointments"
//                   className="bg-emerald-600 text-white px-8 py-3 rounded-full font-medium hover:bg-emerald-700 transition-all duration-200 transform hover:scale-105 flex items-center justify-center"
//                 >
//                   Book Consultation
